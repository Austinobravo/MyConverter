...
SECRET_KEY = 'django-insecure-1=l&vwnlkx@d&2czd99!pidrgxjd9p*8xz93h^c3ymmh1@alox'
...
MEDIA_ROOT = BASE_DIR / 'static/store'
# LOCAL_MEDIA = BASE_DIR / 'static/store/documents/'
